    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-primary border-t border-primary-foreground/20 p-3">
      <div className="max-w-7xl mx-auto">
        <Button 
          ...
          onClick={handleCall}
        >
          <span className="text-xl sm:text-2xl md:text-3xl">$</span> <span className="text-green-400">Save Thousands on Insurance:</span> Click to Qualify for an IR Shingle (Upgrade Before You Renew)!
        </Button>
      </div>
    </div>
  );
