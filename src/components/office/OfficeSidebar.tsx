...
import { BarChart3, Settings, X, ChevronLeft, ChevronRight, Briefcase } from "lucide-react";
import { NavLink, useLocation } from "react-router-dom";
import { cn } from "@/lib/utils";

const navItems = [
  { icon: BarChart3, label: "Dashboard", path: "/office/dashboard" },
  { icon: Settings, label: "Settings", path: "/office/settings" },
];
...
export function OfficeSidebar({ mobileOpen = false, onMobileClose }: OfficeSidebarProps) {
