        ...
        <section className="section-padding">
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {/* Contact Form */}
              <div>
                <h2 className="text-3xl font-heading uppercase mb-6">Send Us a Message</h2>
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-3xl font-heading uppercase mb-6">Contact Information</h2>
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:4057248092" className="text-muted-foreground hover:text-accent transition-colors">
                          (405) 724-8092
                        </a>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@nextgenroofingok.com" className="text-muted-foreground hover:text-accent transition-colors">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-heading uppercase mb-1">Service Area</h3>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-heading uppercase mb-1">Hours</h3>
                        <p className="text-muted-foreground">
                ...
                {/* Map Embed */}
                <div className="bg-section-alt rounded-lg overflow-hidden h-64">
                  <iframe
