...
import { Loader2, Plus, X, Mail, ArrowRight } from 'lucide-react';
...
export default function NotificationRouting() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-heading text-foreground">Notification Routing</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Manage which email addresses receive each type of automated notification.
        </p>
      </div>
      ...
      {/* Link to Report Settings for weekly report routing */}
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-base flex items-center gap-2">
            <Mail className="h-4 w-4 text-accent" />
          ...
          <CardDescription className="text-xs mt-1">
            Weekly report recipients are managed in Report Settings.
          </CardDescription>
        </CardHeader>
        <CardContent>
